...
namespace TRUNGTAMTINHOC.TruyCapDuLieu
{
    class DanhGiaKhoaHocDB
    {
        ...
        public static DataTable DS_Danhgia_HVKH()
        {
            string connectString = ConfigurationManager.ConnectionStrings["TTTH"].ConnectionString.ToString();
            SqlConnection con = new SqlConnection(connectString);
            con.Open();
            ...
            try
            {
                string sql = "EXEC SP_DS_Danhgia_HVKH";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
        ...
        public static bool DanhGiaKH (string mahv, string kh)
        {
            string connectString = ConfigurationManager.ConnectionStrings["TTTH"].ConnectionString.ToString();
            SqlConnection con = new SqlConnection(connectString);
            con.Open();
            ...
            try
            {
                string sql = "EXEC SP_DANHGIA_KHOAHOC '" + mahv + "', '" + kh + "'";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
                con.Close();
                return true;
        ...
        public static DataTable DSCCVB_KhoaHoc()
        {
            string connectString = ConfigurationManager.ConnectionStrings["TTTH"].ConnectionString.ToString();
            SqlConnection con = new SqlConnection(connectString);
            con.Open();
